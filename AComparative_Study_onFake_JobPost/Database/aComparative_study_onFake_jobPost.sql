...
--
-- Host: localhost
-- Generation Time: Nov 17, 2021 at 06:32 AM
...
--
-- Database: `acomparative_study_onfake_jobpost`
--
CREATE DATABASE IF NOT EXISTS `acomparative_study_onfake_jobpost` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `acomparative_study_onfake_jobpost`;
...
('5e1mf6fu7amny3xr9sa89m0c06axtla0', 'eyJ1c2VyaWQiOjI2fQ:1mmv7l:pFLpYGSLs5aMKh4GoooDfBf4RwdheFB1HDpUB6F5BXc', '2021-11-30 09:51:33.689334'),
...
('d12bdw8h6ulq2lrg3wcu6cnuryslkdic', 'eyJ1c2VyaWQiOjI3fQ:1mmy1m:OVnKWSwZyeNkTkP8RT1B52DkyasV1C0MZwgu5R3GiLo', '2021-11-30 12:57:34.867797'),
...
(26, 'Rajesh', 'Rajesh123@gmail.com', 'Rajesh', '9535866270', 'India', 'Karnataka', 'Bangalore'),
(27, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore');
...
--
-- Table structure for table `remote_user_job_post_prediction`
--

CREATE TABLE IF NOT EXISTS `remote_user_job_post_prediction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Job_Id` varchar(300) NOT NULL,
  `Actual_Fake` varchar(300) NOT NULL,
  `Predicted_Fake` varchar(300) NOT NULL,
  `Prediction_Details` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `remote_user_prediction_results`
--

CREATE TABLE IF NOT EXISTS `remote_user_prediction_results` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `Job_Id` varchar(300) NOT NULL,
  `Actual_Fake` varchar(300) NOT NULL,
  `Predicted_Fake` varchar(300) NOT NULL,
