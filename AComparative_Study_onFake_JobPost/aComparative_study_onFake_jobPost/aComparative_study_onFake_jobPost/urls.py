"""aComparative_study_onFake_jobPost URL Configuration
...
urlpatterns = [
    ...
    url(r'^Find_Predict_Jop_Post_Type_Details_Ratio/$', serviceprovider.Find_Predict_Jop_Post_Type_Details_Ratio, name="Find_Predict_Jop_Post_Type_Details_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^Predict_Jop_Post_Type_Details/$', serviceprovider.Predict_Jop_Post_Type_Details, name="Predict_Jop_Post_Type_Details"),
